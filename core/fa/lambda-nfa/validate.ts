import { NFA, FiniteAutomaton, Automaton, AutomatonBase, Transition, StateId, ValidationResult, ValidationError, LambdaNFA } from "../../../types"
...
export function validateLambdaNFA(fa: LambdaNFA & AutomatonBase): ValidationResult {
